...
{
    int nSubscriptionType; //    订阅方式：0：设置 1：增加 2：删除 3：清空订阅、恢复为全市场推送
    int nItems;            //指示后续数组记录数
};
struct TDFDefine_Subscription{
    char chMarket[4]; //  市场 :“SZ”深圳 “SH”上海 “CF”中国金融期货交易所 “SP”商品期货
    char chSymbol[8]; // 代码,如”600000”
};
...
typedef TDFDefine_TransactionExHead  hfs_transactionex_head_t;
typedef TDFDefine_TransactionEx      hfs_transactionex_t;
...
class HfsSecuTable : public boost::serialization::singleton<HfsSecuTable> {
    //friend class boost::serialization::detail::singleton_wrapper<HfsSecuTable>;
