...
def check(dte):
    bRight1, msg1 = dataCheck('../L2data/SH/', dte).check_data()
    bRight2, msg2 = dataCheck('../L2data/SZ/', dte).check_data()
...
if __name__ == '__main__':
    ...
    for dte in [ 20170601,20170602,20170603,20170531,20171213,20170526,20170525,20170524]:
        check(dte)
